...
var MasterTables = function MasterTables() {
  ...
  return __jsx("div", null, __jsx(antd__WEBPACK_IMPORTED_MODULE_4__["Modal"], {
    ...
    return __jsx("div", {
      ...
      onClick: function onClick() {
        setoldmaster(ind.splice(key, 1, handleType));
        console.log(type, "helloWorld");
      },
      style: {
        border: "1px solid",
