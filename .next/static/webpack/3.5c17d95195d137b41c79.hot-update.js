  ...
  return __jsx("div", null, __jsx(antd__WEBPACK_IMPORTED_MODULE_5__["Modal"], {
    ...
    return __jsx("div", {
      ...
      onClick: function onClick() {
        setoldmaster(Masstatus.splice(key, 1, commentHandleStatus)); // console.log(commentStatus,"helloWorld");
      },
      style: {
        border: "1px solid",
        padding: "5px"
